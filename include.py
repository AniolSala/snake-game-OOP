...
class Snake:
    ...
    def move_snake(self):
        '''
        If the snake can't do the movement, return False. Elsewhise, move the
        snake and return True.

        The head of the snake is choosen to be the last element of self.blocks
        '''
    ...
    def check_block_pos(self):
        '''
        Check if the next position of the head crashes with some
        of the blocks of the tail
        '''
